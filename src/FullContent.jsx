        ...
        <>      
            {status === "active" ? <div>  
                ...
                <div className="full-content-items">
                    ...
                    {author === "Salma Hayek" ? <img className="face-picture" src={hayek} alt="hayek"/> : null || author === "Teresa Zimmer" ? <img className="face-picture" src={zimmer} alt="zimmer"/> : null || author === "Sue Doe" ? <img className="face-picture" src={doe} alt="doe"/> : null}

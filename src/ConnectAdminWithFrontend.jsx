...
const ConnectAdminWithFrontend = () => {
    ...
    const changeStatus = (status, id) => {
        const modifiedData = data.map(item => ({
            ...item,
            status: item.id === id && item.status !== "inactive" ? status : item.status,
        }));
